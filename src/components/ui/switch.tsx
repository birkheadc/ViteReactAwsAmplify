...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "group-hover:bg-secondary-300 dark:group-hover:bg-secondary-500 pointer-events-none block h-5 w-5 rounded-full bg-primary-200 shadow-lg transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0 dark:bg-primary-600"
      )}
    >
      {children}
    </SwitchPrimitives.Thumb>
